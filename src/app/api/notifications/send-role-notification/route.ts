...
import { sendNotificationToMultipleDevices } from '@/lib/firebase-admin'
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.error('❌ Firebase admin import hatası:', importError)
    }
    ...
    console.log('✅ Rol bazlı bildirim başarıyla gönderildi')
    ...
    console.error('Rol bazlı bildirim hatası:', error)
    return NextResponse.json(
      { 
